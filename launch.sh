...
if [ "$1" = "install" ]; then
  ...
  chmod 777 segreto.sh
   ...
   echo -e "     > Channel : @Segreto_Ch                        "
   echo -e "     > Editor : @PrswShrr                      "
   echo -e "     > Bot ID : @SegretoTG                        "
   echo -e "     > Github : GitHub.com/Parsaw/SegretoTG     "
   echo -e "                                              \033[0;00m"
   echo -e "\e[36m"
  ./tg/bin/telegram-cli -k ./tg/tg-server.pub -s ./bot/segretobot.lua -l 1 -E $@
fi
